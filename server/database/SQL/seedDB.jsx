...
const seedData = async () => {
  await db.sync()
    ...
    .then( async () => {
      let start = new Date();
      await db.query(`ALTER TABLE user_confirmations DROP CONSTRAINT "user_confirmations_confirmationId_fkey"`);
      await db.query(`ALTER TABLE user_confirmations DROP CONSTRAINT "user_confirmations_userId_fkey"`);
      await db.query(`ALTER TABLE user_histories DROP CONSTRAINT "user_histories_historyId_fkey"`);
      await db.query(`ALTER TABLE user_histories DROP CONSTRAINT "user_histories_userId_fkey"`);
      await db.query(`ALTER TABLE friend_requests DROP CONSTRAINT "friend_requests_userId_fkey"`);
      await db.query(`ALTER TABLE friend_requests DROP CONSTRAINT "friend_requests_friendId_fkey"`);
      await db.query(`ALTER TABLE friends DROP CONSTRAINT "friends_userId_fkey"`);
      await db.query(`ALTER TABLE friends DROP CONSTRAINT "friends_friendId_fkey"`);
      let end = new Date();
